...
.globl _func_deg_9_T_3_el_0
.globl func_deg_9_T_3_el_0
### void func_deg_9_T_3_el_0(__m128i *F, __m128i **F_sp, void *buf, uint64_t *num, uint64_t idx);
...
##### step 1 [hw=1]
##### F[ 1 ] ^= ( F[ 1 ] ^= ( F[ alpha + 1 ] ^= ( F[ beta + 1 ] ^= ( F[ gamma + 1 ] ^= ( F[ delta + 1 ] ^= ( F[ epsilon + 1 ] ^= ( F[ zeta + 1 ] ^= ( F[ eta + 1 ] ^= ( F[ iota + 1 ]))))))))))

movdqa 16(%rdi,%rbx), %xmm14
pxor 16(%rdi,%r15), %xmm14
movdqa %xmm14, 16(%rdi,%r15)
...
movdqa 32(%rdi,%rbx), %xmm14
pxor 32(%rdi,%r15), %xmm14
movdqa %xmm14, 32(%rdi,%r15)
...
##### step 3 [hw=2]
##### F[ 2 ] ^= ( F[ 2 ] ^= ( F[ 2 ] ^= ( F[ alpha + 2 ] ^= ( F[ beta + 2 ] ^= ( F[ gamma + 2 ] ^= ( F[ delta + 2 ] ^= ( F[ epsilon + 2 ] ^= ( F[ zeta + 2 ] ^= ( F[ eta + 2 ]))))))))))

movdqa 48(%rdi,%r15), %xmm14
pxor 48(%rdi,%r14), %xmm14
movdqa %xmm14, 48(%rdi,%r14)
...
movdqa 48(%rdi,%rbx), %xmm14
pxor 64(%rdi,%r15), %xmm14
movdqa %xmm14, 64(%rdi,%r15)
...
pxor 80(%rdi,%r14), %xmm14
movdqa %xmm14, 80(%rdi,%r14)
...
pxor 96(%rdi,%r14), %xmm14
movdqa %xmm14, 96(%rdi,%r14)
...
##### step 7 [hw=3]
##### F[ 3 ] ^= ( F[ 3 ] ^= ( F[ 3 ] ^= ( F[ 3 ] ^= ( F[ alpha + 3 ] ^= ( F[ beta + 3 ] ^= ( F[ gamma + 3 ] ^= ( F[ delta + 3 ] ^= ( F[ epsilon + 3 ] ^= ( F[ zeta + 3 ]))))))))))
...
movdqa 64(%rdi,%rbx), %xmm14
pxor 112(%rdi,%r15), %xmm14
movdqa %xmm14, 112(%rdi,%r15)
pxor 128(%rdi,%r14), %xmm14
movdqa %xmm14, 128(%rdi,%r14)
...
movdqa 128(%rdi,%r15), %xmm14
pxor 144(%rdi,%r14), %xmm14
movdqa %xmm14, 144(%rdi,%r14)
...
movdqa 144(%rdi,%r15), %xmm14
pxor 160(%rdi,%r14), %xmm14
movdqa %xmm14, 160(%rdi,%r14)
...
movdqa 160(%rdi,%r15), %xmm14
pxor 192(%rdi,%r14), %xmm14
movdqa %xmm14, 192(%rdi,%r14)
...
pxor 208(%rdi,%r13), %xmm14
movdqa %xmm14, 208(%rdi,%r13)
...
pxor 224(%rdi,%r13), %xmm14
movdqa %xmm14, 224(%rdi,%r13)
...
##### step 15 [hw=4]
##### F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ alpha + 4 ] ^= ( F[ beta + 4 ] ^= ( F[ gamma + 4 ] ^= ( F[ delta + 4 ] ^= ( F[ epsilon + 4 ]))))))))))
...
movdqa 80(%rdi,%rbx), %xmm14
pxor 176(%rdi,%r15), %xmm14
movdqa %xmm14, 176(%rdi,%r15)
pxor 240(%rdi,%r14), %xmm14
movdqa %xmm14, 240(%rdi,%r14)
...
movdqa 208(%rdi,%r15), %xmm14
pxor 272(%rdi,%r14), %xmm14
movdqa %xmm14, 272(%rdi,%r14)
pxor 288(%rdi,%r13), %xmm14
movdqa %xmm14, 288(%rdi,%r13)
...
movdqa 224(%rdi,%r15), %xmm14
pxor 304(%rdi,%r14), %xmm14
movdqa %xmm14, 304(%rdi,%r14)
pxor 320(%rdi,%r13), %xmm14
movdqa %xmm14, 320(%rdi,%r13)
...
pxor 336(%rdi,%r13), %xmm14
movdqa %xmm14, 336(%rdi,%r13)
...
pxor 368(%rdi,%r12), %xmm14
movdqa %xmm14, 368(%rdi,%r12)
...
movdqa 240(%rdi,%r15), %xmm14
pxor 352(%rdi,%r14), %xmm14
movdqa %xmm14, 352(%rdi,%r14)
pxor 384(%rdi,%r13), %xmm14
movdqa %xmm14, 384(%rdi,%r13)
...
movdqa 368(%rdi,%r14), %xmm14
pxor 400(%rdi,%r13), %xmm14
movdqa %xmm14, 400(%rdi,%r13)
...
pxor 464(%rdi,%r12), %xmm14
movdqa %xmm14, 464(%rdi,%r12)
...
##### step 31 [hw=5]
##### F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ alpha + 5 ] ^= ( F[ beta + 5 ] ^= ( F[ gamma + 5 ] ^= ( F[ delta + 5 ]))))))))))
...
movdqa 96(%rdi,%rbx), %xmm14
pxor 256(%rdi,%r15), %xmm14
movdqa %xmm14, 256(%rdi,%r15)
pxor 416(%rdi,%r14), %xmm14
movdqa %xmm14, 416(%rdi,%r14)
pxor 496(%rdi,%r13), %xmm14
movdqa %xmm14, 496(%rdi,%r13)
...
movdqa 272(%rdi,%r15), %xmm14
pxor 432(%rdi,%r14), %xmm14
movdqa %xmm14, 432(%rdi,%r14)
pxor 512(%rdi,%r13), %xmm14
movdqa %xmm14, 512(%rdi,%r13)
...
movdqa 288(%rdi,%r15), %xmm14
pxor 448(%rdi,%r14), %xmm14
movdqa %xmm14, 448(%rdi,%r14)
...
movdqa 464(%rdi,%r14), %xmm14
pxor 544(%rdi,%r13), %xmm14
movdqa %xmm14, 544(%rdi,%r13)
...
movdqa 304(%rdi,%r15), %xmm14
pxor 480(%rdi,%r14), %xmm14
movdqa %xmm14, 480(%rdi,%r14)
pxor 560(%rdi,%r13), %xmm14
movdqa %xmm14, 560(%rdi,%r13)
...
movdqa 496(%rdi,%r14), %xmm14
pxor 576(%rdi,%r13), %xmm14
movdqa %xmm14, 576(%rdi,%r13)
...
movdqa 512(%rdi,%r14), %xmm14
pxor 592(%rdi,%r13), %xmm14
movdqa %xmm14, 592(%rdi,%r13)
pxor 608(%rdi,%r12), %xmm14
movdqa %xmm14, 608(%rdi,%r12)
...
movdqa 320(%rdi,%r15), %xmm14
pxor 528(%rdi,%r14), %xmm14
movdqa %xmm14, 528(%rdi,%r14)
pxor 624(%rdi,%r13), %xmm14
movdqa %xmm14, 624(%rdi,%r13)
...
movdqa 544(%rdi,%r14), %xmm14
pxor 640(%rdi,%r13), %xmm14
movdqa %xmm14, 640(%rdi,%r13)
...
movdqa 560(%rdi,%r14), %xmm14
pxor 656(%rdi,%r13), %xmm14
movdqa %xmm14, 656(%rdi,%r13)
...
movdqa 576(%rdi,%r14), %xmm14
pxor 688(%rdi,%r13), %xmm14
movdqa %xmm14, 688(%rdi,%r13)
...
movdqa 704(%rdi,%r13), %xmm14
pxor 720(%rdi,%r12), %xmm14
movdqa %xmm14, 720(%rdi,%r12)
...
movdqa 336(%rdi,%r15), %xmm14
pxor 592(%rdi,%r14), %xmm14
movdqa %xmm14, 592(%rdi,%r14)
pxor 736(%rdi,%r13), %xmm14
movdqa %xmm14, 736(%rdi,%r13)
...
movdqa 608(%rdi,%r14), %xmm14
pxor 752(%rdi,%r13), %xmm14
movdqa %xmm14, 752(%rdi,%r13)
...
movdqa 624(%rdi,%r14), %xmm14
pxor 768(%rdi,%r13), %xmm14
movdqa %xmm14, 768(%rdi,%r13)
...
movdqa 784(%rdi,%r13), %xmm14
pxor 816(%rdi,%r12), %xmm14
movdqa %xmm14, 816(%rdi,%r12)
...
movdqa 640(%rdi,%r14), %xmm14
pxor 800(%rdi,%r13), %xmm14
movdqa %xmm14, 800(%rdi,%r13)
pxor 832(%rdi,%r12), %xmm14
movdqa %xmm14, 832(%rdi,%r12)
...
movdqa 832(%rdi,%r13), %xmm14
pxor 864(%rdi,%r12), %xmm14
movdqa %xmm14, 864(%rdi,%r12)
...
pxor 880(%rdi,%r11), %xmm14
movdqa %xmm14, 880(%rdi,%r11)
...
movdqa 656(%rdi,%r14), %xmm14
pxor 848(%rdi,%r13), %xmm14
movdqa %xmm14, 848(%rdi,%r13)
pxor 896(%rdi,%r12), %xmm14
movdqa %xmm14, 896(%rdi,%r12)
...
movdqa 864(%rdi,%r13), %xmm14
pxor 912(%rdi,%r12), %xmm14
movdqa %xmm14, 912(%rdi,%r12)
...
movdqa 896(%rdi,%r13), %xmm14
pxor 960(%rdi,%r12), %xmm14
movdqa %xmm14, 960(%rdi,%r12)
...
##### step 63 [hw=6]
##### F[ 6 ] ^= ( F[ 6 ] ^= ( F[ 6 ] ^= ( F[ 6 ] ^= ( F[ 6 ] ^= ( F[ 6 ] ^= ( F[ 6 ] ^= ( F[ alpha + 6 ] ^= ( F[ beta + 6 ] ^= ( F[ gamma + 6 ]))))))))))

movdqa 1008(%rdi,%r11), %xmm14
