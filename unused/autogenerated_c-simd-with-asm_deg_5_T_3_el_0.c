...
// generated with L = 8
void exhaustive_sse2_deg_5_T_3_el_0(LUT_t LUT, int n, pck_vector_t nonsimd_F[], solution_callback_t callback, void* callback_state, int verbose) {
      ...
      for(int idx_2=0; idx_2<idx_1; idx_2++) {
        ...
        for(int idx_3=0; idx_3<idx_2; idx_3++) {
          ...
          for(uint64_t j=256; j<(1ull << idx_3); j+=256) {
                ...
                func_deg_5_T_3_el_0(F, &F_sp[0], solution_buffer, &n_solutions_found, i);
