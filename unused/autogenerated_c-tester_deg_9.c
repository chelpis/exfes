...
pck_vector_t packed_eval_deg_9(LUT_t LUT, int n, pck_vector_t F[], uint64_t i) {
            ...
            for(int idx_5=0; idx_5<idx_4; idx_5++) {
              ...
              for(int idx_6=0; idx_6<idx_5; idx_6++) {
                ...
                for(int idx_7=0; idx_7<idx_6; idx_7++) {
                  const pck_vector_t v_7 = v_6 & v[idx_7];

                  // computes the contribution of degree-8 terms
                  y ^= F[ idx_8(LUT, idx_7, idx_6, idx_5, idx_4, idx_3, idx_2, idx_1, idx_0) ] & v_7;

                  for(int idx_8=0; idx_8<idx_7; idx_8++) {
                    const pck_vector_t v_8 = v_7 & v[idx_8];

                    // computes the contribution of degree-9 terms
                    y ^= F[ idx_9(LUT, idx_8, idx_7, idx_6, idx_5, idx_4, idx_3, idx_2, idx_1, idx_0) ] & v_8;
