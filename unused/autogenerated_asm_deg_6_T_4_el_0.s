...
.globl _func_deg_6_T_4_el_0
.globl func_deg_6_T_4_el_0
### void func_deg_6_T_4_el_0(__m128i *F, __m128i **F_sp, void *buf, uint64_t *num, uint64_t idx);
...
##### step 1 [hw=1]
##### F[ 1 ] ^= ( F[ 1 ] ^= ( F[ alpha + 1 ] ^= ( F[ beta + 1 ] ^= ( F[ gamma + 1 ] ^= ( F[ delta + 1 ] ^= ( F[ epsilon + 1 ])))))))
...
##### step 3 [hw=2]
##### F[ 2 ] ^= ( F[ 2 ] ^= ( F[ 2 ] ^= ( F[ alpha + 2 ] ^= ( F[ beta + 2 ] ^= ( F[ gamma + 2 ] ^= ( F[ delta + 2 ])))))))
...
##### step 7 [hw=3]
##### F[ 3 ] ^= ( F[ 3 ] ^= ( F[ 3 ] ^= ( F[ 3 ] ^= ( F[ alpha + 3 ] ^= ( F[ beta + 3 ] ^= ( F[ gamma + 3 ])))))))
...
##### step 15 [hw=4]
##### F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ 4 ] ^= ( F[ alpha + 4 ] ^= ( F[ beta + 4 ])))))))
...
##### step 31 [hw=5]
##### F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ 5 ] ^= ( F[ alpha + 5 ])))))))
...
pxor 1520(%rdi,%rax), %xmm14
movdqa %xmm14, 1520(%rdi,%rax)
pxor 1552(%rdi), %xmm14
...
pxor 1440(%rdi,%r10), %xmm14
movdqa %xmm14, 1440(%rdi,%r10)
