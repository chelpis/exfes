...
.globl _func_deg_3_T_4_el_0
.globl func_deg_3_T_4_el_0
### void func_deg_3_T_4_el_0(__m128i *F, __m128i **F_sp, void *buf, uint64_t *num, uint64_t idx);
...
##### step 1 [hw=1]
##### F[ 1 ] ^= ( F[ 1 ] ^= ( F[ alpha + 1 ] ^= ( F[ beta + 1 ]))))

movdqa 16(%rdi,%r10), %xmm14
...
##### step 3 [hw=2]
##### F[ 2 ] ^= ( F[ 2 ] ^= ( F[ 2 ] ^= ( F[ alpha + 2 ]))))

pxor 48(%rdi,%rax), %xmm3
pxor %xmm3, %xmm1
pxor %xmm1, %xmm0
pcmpeqb %xmm0, %xmm15
pmovmskb %xmm15, %r11d
