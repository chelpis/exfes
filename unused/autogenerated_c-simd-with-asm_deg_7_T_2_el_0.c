...
// generated with L = 7
void exhaustive_sse2_deg_7_T_2_el_0(LUT_t LUT, int n, pck_vector_t nonsimd_F[], solution_callback_t callback, void* callback_state, int verbose) {
          ...
          for(int idx_4=0; idx_4<idx_3; idx_4++) {
            ...
            for(int idx_5=0; idx_5<idx_4; idx_5++) {
              ...
              for(uint64_t j=128; j<(1ull << idx_5); j+=128) {
                    ...
                    func_deg_7_T_2_el_0(F, &F_sp[0], solution_buffer, &n_solutions_found, i);
