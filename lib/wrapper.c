...
int convert_input_equations(const int n, const int degree, int from, int to,
...
int solution_tester(void *_state, uint64_t size, uint64_t *n_solutions) {
  ...
  // assert( state->degree < enumerated_degree_bound); //
  // enumerated_degree_bound is defined in fes.h
